...
insert into programmes (name, curriculum, level, vacancies, status, summary, description, how_to_apply, required_documents) values
  ('Cambridge IGCSE', 'Cambridge IGCSE', 'Years 9 - 11', 12, 'open',
   'Broad, internationally-recognised subjects for Years 9 to 11.',
   'Our Cambridge IGCSE pathway prepares learners for internationally recognised qualifications across sciences, humanities, mathematics and languages, with small class sizes and continuous assessment.',
  ...
  ('Pearson Edexcel A-Level', 'Edexcel', 'Years 12 - 13', 6, 'open',
   'Specialist A-Level subject combinations for senior learners.',
   'A focused two-year A-Level programme with subject combinations tailored to each learner''s university and career goals.',
...
insert into cert_courses (name, curriculum, status) values
  ('Additional Mathematics', 'Cambridge IGCSE', 'open'),
  ('English Language', 'Cambridge IGCSE', 'open'),
  ('Physics', 'Pearson Edexcel A-Level', 'open'),
  ('Mathematics', 'IB Diploma Programme', 'open'),
  ('Integrated Science', 'CBE Junior School', 'open');
